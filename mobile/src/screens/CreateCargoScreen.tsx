  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>ایجاد بار جدید</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      {/* Title */}
      <Text style={styles.fieldLabel}>عنوان (اختیاری)</Text>
      <TextInput
        style={styles.input}
        value={title}
      ...
      {/* Dates */}
      <Text style={styles.fieldLabel}>تاریخ بارگیری (اختیاری)</Text>
      <TextInput
        style={styles.input}
        value={pickupAt}
      ...
      <Text style={styles.fieldLabel}>مهلت تحویل (اختیاری)</Text>
      <TextInput
        style={styles.input}
        value={deliverBy}
      ...
      >
        <Text style={styles.submitButtonText}>
          {loading ? 'در حال ایجاد...' : 'ایجاد بار'}
        </Text>
      </Pressable>
    </ScrollView>
  );
